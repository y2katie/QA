...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new TabManager('.audit-tab-btn', '.audit-content');
        ...
        inputs.forEach((input, index) => {
            ...
            results += `
                <div class="analysis-result ${hasGoodName ? 'good' : 'bad'}">
                    ...
                    ${!hasGoodName ? '<p class="warning">WARNING: Missing or poor accessible name</p>' : '<p class="success">GOOD: Good accessible name</p>'}
                </div>
            `;
        });
                ...
                if (results) {
                    results.innerHTML = `
                        ...
                        <div class="issues-list">
                            <div class="issue">
                                <strong>ERROR - Email field:</strong> No proper label association
                            </div>
                            <div class="issue">
                                <strong>ERROR - Password field:</strong> Help text not connected with aria-describedby
                            </div>
                            <div class="issue">
                                <strong>ERROR - Checkbox:</strong> No label association
                            </div>
                            <div class="issue">
                                <strong>ERROR - Submit button:</strong> Not a real button element
                            </div>
                        </div>
                    `;
                    results.style.display = 'block';
                ...
                if (results) {
                    results.innerHTML = `
                        ...
                        <div class="nav-issues">
                            <div class="issue">
                                <strong>ERROR - No accessible names:</strong> Icons have no text alternatives
                            </div>
                            <div class="issue">
                                <strong>ERROR - No semantic roles:</strong> Using generic divs instead of buttons/links
                            </div>
                            <div class="issue">
                                <strong>ERROR - No keyboard support:</strong> Cannot navigate with Tab key
                            </div>
                            <div class="issue">
                                <strong>ERROR - No current state:</strong> Active item not announced to screen readers
                            </div>
                        </div>
                    `;
                    results.style.display = 'block';
